  ...
  const emailTemplates = [
    {
      ...
      subject:
        "Welcome to Our Consultancy - Your Education Journey Starts Here!",
...
<p>We noticed you started an application but haven't completed it yet. Let us help you finish!</p>`,
  ...
  const handleSendEmails = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.EXPO_PUBLIC_API_URL}/dashboard/bulk-send`,
        {
          method: "POST",
      ...
      if (data.success) {
        ...
        Alert.alert(
          "Success",
          `Sent ${data.sentCount || 0} emails successfully!`,
        );
      } else {
          ...
          <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
            ...
            <View className="px-6 pt-12 pb-4">
              <View className="flex-row items-center justify-between mb-6">
                ...
                >
                  <Eye
                    size={20}
                    color={emailData.subject ? "#60a5fa" : "#6b7280"}
                  />
                </TouchableOpacity>
              </View>
            </View>
            ...
            <View className="px-6 mb-6">
              <View className="bg-gradient-to-r from-purple-900/20 to-blue-900/20 rounded-xl p-4 border border-purple-500/20">
                ...
                <Text className="text-gray-400 text-sm">
                  Emails will be sent to {recipientCount} recipient
                  {recipientCount !== 1 ? "s" : ""}
                </Text>
                {recipientCount > 100 && (
              ...
              <View className="bg-white/5 rounded-2xl p-5 border border-blue-500/20">
                ...
                <View className="mb-4">
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      handleEmailChange("htmlContent", text)
                    }
                    multiline
                    numberOfLines={8}
              ...
              <View className="flex-1 bg-gray-900 m-4 rounded-2xl p-6 mt-12">
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                  ...
                  <View className="mt-6 p-4 bg-blue-900/20 rounded-xl border border-blue-500/30">
                    ...
                    <Text className="text-gray-400 text-sm">
                      Placeholders like {"{firstName}"}, {"{lastName}"}, etc.
